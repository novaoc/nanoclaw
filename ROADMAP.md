...
- **Holodex backends.** The demo sandbox ([Holodex](https://github.com/novaoc/holodex))
  supports both static demos and verified container applications with no
  runtime network egress and hard CPU/RAM/process caps.
